window.addEventListener("scroll", function () {
  ...
  if (window.scrollY > 50) {
    // Ha az oldal le van görgetve 50px-nél többet
...
const responsiveMenu = document.getElementById("menu-list");
closeBtn.style.display = "none";
responsiveMenu.style.top = "100vh";
...
window.addEventListener("scroll", function () {
  ...
  if (window.scrollY > 300) {
    // Ha az oldal le van görgetve 300px-nél többet
